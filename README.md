...
Un point, un point d'exclamation, un point d'interrogation ou des points de suspension forcent toujours un nouveau segment. Une phrase peut dépasser légèrement la cible de 90 caractères, jusqu'à 120, afin de ne jamais créer un fragment orphelin de quelques mots. Les phrases plus longues sont divisées de manière équilibrée, de préférence sur une virgule puis sur un espace. Entre deux phrases, Voice Forge crée une pause naturelle de 90 ms avec des bords adoucis. Lorsqu'une phrase trop longue doit malgré tout être divisée, les morceaux sont raccordés par un fondu croisé de 40 ms. La pause configurée dans l'écran Dialogue ne s'applique qu'entre les répliques.
